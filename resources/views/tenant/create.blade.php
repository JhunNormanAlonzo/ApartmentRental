                        ...
                        <div class="card-body">
                            ...
                            <form action="{{route('tenants.store')}}" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6 mt-2">
                                        <x-input id="password" name="password" type="text" placeholder="Password" value="{{old('password')}}">
                                            <x-validation-error name="password"></x-validation-error>
                                        </x-input>
                                    </div>

                                    <div class="col-6 mt-2">
                                        <x-input id="contact_number" name="contact_number" type="tel" placeholder="Contact Number" value="{{old('contact_number')}}">
                                            <x-validation-error name="contact_number"></x-validation-error>
                                        </x-input>
                                    </div>
                                    <div class="col-12 mt-2">
                                        <textarea class="tinymce form-select @error('address') is-invalid @enderror" name="address" placeholder="Address"></textarea>
                                    ...
                                    <div class="col-12 mt-2">
                                        <x-input id="registration_date" name="registration_date" type="text" placeholder="Registration Date" value="{{old('registration_data')}}">
